...
call s:InitVariable('g:indent_guides_exclude_popup', 1)
...
augroup indent_guides
  ...
  autocmd BufWinEnter,WinEnter,FileType * call indent_guides#process_autocmds()

  " Trigger BufEnter and process modelines.
  autocmd ColorScheme * doautocmd indent_guides BufWinEnter

  " Trigger on tabswidth change
  autocmd OptionSet shiftwidth,tabstop,expandtab call indent_guides#process_autocmds()
augroup END
